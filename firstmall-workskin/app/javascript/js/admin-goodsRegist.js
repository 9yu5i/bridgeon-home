...
function addFilterGroupRow(){
	var html = "";
	html += '<tr>';
	html += '	<td class="center"><input type="text" name="filterGroupTitle[]" value="" class="wp85"/></td>';
	html += '	<td class="center"><input type="text" name="filterGroupValues[]" value="" class="wp85"/></td>';
	html += '	<td class="center"><button type="button" class="btn_minus goodsSubInfoDel" onclick="del_subInfo(this);"></button></td>';
	html += '</tr>';
	$("tbody#filterGroupTable").append(html);
}
