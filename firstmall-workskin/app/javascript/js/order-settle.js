...
function use_signature_required(is_required) {
	if (is_required) {
		$("#signature_required_order_summary").show();
	} else {
		$("#signature_required_order_summary").hide();
	}
...
$(document).ready(function() {
	...
	$("#signature_checkbox").on("change", function () {
		const isChecked = $(this).is(":checked");
		use_signature_required(isChecked);
	});

	$("#same_as_ordered_checkbox").on("change", function () {
		const isChecked = $(this).is(":checked");
		if (isChecked) {
			console.log("TEST");
			copy_order_info();
