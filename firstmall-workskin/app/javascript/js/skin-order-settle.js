	...
	$(window).load(function(){
		...
		$("#copy_order_info").bind("click",function(){
			...
			$("input[name='recipient_user_first_name']").val( $("input[name='order_user_first_name']").val() );
			$("input[name='recipient_user_last_name']").val( $("input[name='order_user_last_name']").val() );
		...
		$("#copy_delivery_info").bind("click",function(){
			if($("input[name='order_user_name']").attr('readonly') != 'readonly'){
				...
				$("input[name='order_user_first_name']").val( $("input[name='recipient_user_first_name']").val() );
				$("input[name='order_user_last_name']").val( $("input[name='recipient_user_last_name']").val() );
			}
